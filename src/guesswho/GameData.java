...
question("roast_content", "Are they known for roast or diss-track content?"),
question("reaction_content", "Are they known for reaction-style videos?"),
question("sketch_comedy", "Are they known for sketch comedy videos?"),
question("tech_reviews", "Are they known for reviewing technology?"),
question("smartphone_reviews", "Are they known for smartphone reviews?"),
question("mobile_gaming", "Are they associated with mobile gaming content?"),
...
question("rose_after_2020", "Did they become famous after 2020?"),
        ...
        question("three_khans", "Are they one of Bollywood's three Khans?"),
        question("dance_roles", "Are they especially known for dancing in films?"),
        question("romantic_roles", "Are they especially known for romantic roles?"),
        question("pan_indian_film", "Are they associated with pan-Indian blockbuster films?"),
        question("baahubali_franchise", "Are they connected to Baahubali?"),
        question("rrr_film", "Are they connected to RRR?"),
        question("kgf_franchise", "Are they connected to KGF?"),
        question("pushpa_franchise", "Are they connected to Pushpa?"),
...
person("Shah Rukh Khan",
    ...
    "bollywood", "hindi_language", "three_khans", "romantic_roles",
    "award_winner"),

person("Amitabh Bachchan",
    "alive", "actor", "indian", "famous_before_2000", "film", "television:0.6",
    "bollywood", "hindi_language", "over_70", "award_winner"),
...
person("Priyanka Chopra",
    ...
    "model", "singer_actor:0.6", "social_media", "award_winner"),

person("Deepika Padukone",
    "alive", "female", "actor", "indian", "under_40:0.55", "film",
    "bollywood", "hindi_language", "model", "romantic_roles:0.65",
    "social_media", "award_winner"),
...
person("MrBeast",
    ...
    "youtube", "philanthropy", "meme_famous:0.6", "award_winner:0.55"),
...
person("Ranbir Kapoor",
    ...
    "bollywood", "hindi_language", "famous_family", "romantic_roles",
    "social_media", "award_winner"),

person("Ranveer Singh",
    "alive", "actor", "indian", "film",
    "bollywood", "hindi_language", "dance_roles:0.65", "married",
    "social_media", "award_winner"),

person("Alia Bhatt",
    "alive", "female", "actor", "indian",
    "under_40", "film", "bollywood", "hindi_language", "famous_family",
    "married", "social_media",
    "award_winner"),

person("Katrina Kaif",
    "alive", "female", "actor",
    "indian:0.6", "film", "bollywood", "hindi_language",
    "dance_roles", "married", "social_media",
    "award_winner"),

person("Anushka Sharma",
    "alive", "female", "actor", "indian",
    "film", "bollywood", "hindi_language", "married", "has_children",
    "social_media", "award_winner"),

person("Kriti Sanon",
    "alive", "female", "actor", "indian",
    "under_40", "film", "bollywood", "hindi_language", "model", "social_media",
    "award_winner"),

person("Kiara Advani",
    "alive", "female", "actor", "indian",
    "under_40", "film", "bollywood", "hindi_language", "married",
    "rose_after_2010", "social_media"),

person("Shraddha Kapoor",
    "alive", "female", "actor", "indian",
    "under_40", "film", "bollywood", "hindi_language", "famous_family",
    "singer_actor:0.55", "social_media",
    "award_winner"),

person("Salman Khan",
    "alive", "actor", "indian",
    "film", "bollywood", "hindi_language", "famous_before_2000",
    "three_khans", "action_roles", "social_media", "award_winner"),

person("Aamir Khan",
    "alive", "actor", "indian",
    "film", "bollywood", "hindi_language", "famous_before_2000",
    "three_khans", "director:0.45", "award_winner"),
...
person("Hrithik Roshan",
    "alive", "actor", "indian",
    "film", "bollywood", "hindi_language", "action_roles", "dance_roles",
    "social_media", "award_winner"),

person("Allu Arjun",
    "alive", "actor", "indian",
    "film", "south_indian_cinema", "telugu_language", "action_roles",
    "dance_roles", "pushpa_franchise", "pan_indian_film",
    "social_media", "award_winner"),

person("Prabhas",
    "alive", "actor", "indian",
    "film", "south_indian_cinema", "telugu_language", "action_roles",
    "baahubali_franchise", "pan_indian_film", "award_winner"),

person("Ram Charan",
    "alive", "actor", "indian",
    "film", "south_indian_cinema", "telugu_language", "social_media",
    "rrr_film", "pan_indian_film", "dance_roles:0.55", "award_winner"),

person("Jr NTR",
    "alive", "actor", "indian",
    "film", "south_indian_cinema", "telugu_language", "rrr_film",
    "pan_indian_film", "award_winner"),

person("Yash",
    "alive", "actor", "indian",
    "film", "south_indian_cinema", "kannada_language", "action_roles",
    "kgf_franchise", "pan_indian_film", "social_media"),
...
person("Rashmika Mandanna",
    "alive", "female", "actor",
    "indian", "under_40",
    "film", "south_indian_cinema", "telugu_language", "pushpa_franchise",
    "pan_indian_film", "social_media"),
...
person("CarryMinati",
    ...
    "indian", "under_40",
    "youtube", "roast_content", "rapper:0.45", "meme_famous",
    "social_media",
    "award_winner"),
...
person("Triggered Insaan",
    "alive", "internet_creator",
    "indian", "under_40",
    "youtube", "reaction_content", "gaming:0.55", "mobile_gaming:0.45",
    "comedy:0.65", "social_media"),

person("Bhuvan Bam",
    "alive", "internet_creator",
    "indian", "under_40",
    "youtube", "sketch_comedy", "comedy", "musician:0.45",
    "singer_actor:0.45",
    "social_media"),
...
person("Ashish Chanchlani",
    "alive", "internet_creator",
    "indian", "under_40",
    "youtube", "comedy", "sketch_comedy",
    "social_media"),

person("Tech Burner",
    "alive", "internet_creator",
    "indian", "under_40",
    "youtube", "technology", "tech_reviews", "smartphone_reviews",
    "fashion:0.45",
    "social_media"),
