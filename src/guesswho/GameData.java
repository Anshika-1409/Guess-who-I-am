...
person("Michael Jackson",
    "musician", "american", "famous_before_2000", "solo_music",
    "band_member:0.65", "award_winner"),

person("Freddie Mercury",
    "musician", "european", "famous_before_2000", "band_member",
    "award_winner"),
...
person("Priyanka Chopra",
    ...
    "television:0.45", "singer_actor:0.6", "social_media", "award_winner"),
...
person("Steve Jobs",
    "business", "american", "famous_before_2000",
    "award_winner:0.45"),
...
person("Albert Einstein",
    "scientist", "european", "american:0.45",
    "famous_before_2000", "award_winner"),

person("Princess Diana",
    "female", "royal", "european",
    "famous_before_2000", "award_winner:0.4"),

person("Harry Potter",
    "fictional", "european", "under_40:0.65",
    "film", "award_winner:0.4"),

person("Spider-Man",
    "fictional", "american", "under_40:0.75",
    "film", "superhero", "action_roles"),

person("Mickey Mouse",
    "fictional", "american", "famous_before_2000",
    "film:0.55", "television", "animated"),
...
person("Alia Bhatt",
    ...
    "under_40", "film", "social_media",
    "award_winner"),

person("Katrina Kaif",
    "alive", "female", "actor",
    "indian:0.6", "film", "social_media",
    "award_winner"),

person("Anushka Sharma",
    "alive", "female", "actor", "indian",
    "film", "social_media", "award_winner"),
...
person("MS Dhoni",
    ...
    "famous_before_2000:0.45", "social_media", "award_winner"),
...
person("Hardik Pandya",
    ...
    "team_sport", "cricket", "social_media"),

person("Jasprit Bumrah",
    "alive", "athlete", "indian", "under_40:0.7",
    "team_sport", "cricket", "award_winner"),
...
person("Sundar Pichai",
    ...
    private static Question question(String id, String text) {
        String topic = id.contains("_") ? id.substring(0, id.indexOf('_')) : id;
        return new Question(id, text, topic);
    }
